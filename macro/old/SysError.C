//void SysError(){
{
    ...
    for(Double_t det_ene=1.0; det_ene<25.0; det_ene+=de){
        ...
        gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel1/tel1_%d.png\")",n1));
        n1++;
    ...
    gROOT->ProcessLine("zone");
    g1->Draw("ap");
    gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel1.png\")"));
    ...
    for(Double_t det_ene=1.0; det_ene<25.0; det_ene+=de){
        ...
        gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel2/tel2_%d.png\")",n2));
        n2++;
    ...
    gROOT->ProcessLine("zone");
    g2->Draw("ap");
    gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel2.png\")"));
    ...
    for(Double_t det_ene=1.0; det_ene<25.0; det_ene+=de){
        ...
        gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel3/tel3_%d.png\")",n3));
        n3++;
    ...
    gROOT->ProcessLine("zone");
    g3->Draw("ap");
    gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel3.png\")"));
    ...
    for(Double_t det_ene=1.0; det_ene<25.0; det_ene+=de){
        ...
        gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel4/tel4_%d.png\")",n4));
        n4++;
    ...
    gROOT->ProcessLine("zone");
    g4->Draw("ap");
    gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel4.png\")"));
    ...
    for(Double_t det_ene=1.0; det_ene<25.0; det_ene+=de){
        ...
        gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel5/tel5_%d.png\")",n5));
        n5++;
    ...
    gROOT->ProcessLine("zone");
    g5->Draw("ap");
    gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/tel5.png\")"));
    ...
    gROOT->ProcessLine(Form("artcanvas->Print(\"figure/error/all.png\")"));
