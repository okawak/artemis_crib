...
#for FILE in `ls $DATADIR/high027*.ridf`
#do
#  DATAFILE=${FILE##*/}
#  FILENAME=${DATAFILE%.*}
#  echo "in process ${FILENAME}"
#  python3 /home/okawa/art_analysis/user/okawa/macro/scripts/run_MakeCoinRoot.py ${FILENAME}
#done
...
do
  ...
  echo "in process ${FILENAME}"
  python3 /home/okawa/art_analysis/user/okawa/macro/scripts/run_MakeAlldataRoot.py ${FILENAME} &
done
wait
...
/home/okawa/art_analysis/user/okawa/output/artemis/move.sh
