...
do
  ...
  python3 /home/okawa/art_analysis/user/okawa/macro/scripts/run_MakeBeamCoin.py ${FILENAME} &
done
wait
...
/home/okawa/art_analysis/user/okawa/output/beamcoin/merge.sh
/home/okawa/art_analysis/user/okawa/output/beamcoin/merge_all.sh
