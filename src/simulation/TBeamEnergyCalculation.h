...
#ifndef _TBEAMENERGYCALCULATION_H_
#define _TBEAMENERGYCALCULATION_H_

#include <TProcessor.h>

namespace art {
	class TBeamEnergyCalculation;
}

class TClonesArray;

class art::TBeamEnergyCalculation : public TProcessor {
public:
	TBeamEnergyCalculation();
	virtual ~TBeamEnergyCalculation();
...
private:
	...
	TBeamEnergyCalculation(const TBeamEnergyCalculation& rhs);
	// Assignment operator (prohibited)
	TBeamEnergyCalculation& operator=(const TBeamEnergyCalculation& rhs);
	
	
	ClassDef(TBeamEnergyCalculation,1)
};	
#endif // _TBEAMENERGYCALCULATION_H_