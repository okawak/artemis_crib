...
using art::TSimTGTIKProcessor;

ClassImp(art::TSimTGTIKProcessor)

// Default constructor
TSimTGTIKProcessor::TSimTGTIKProcessor()
...
void TSimTGTIKProcessor::Init(TEventCollection *col)
{
...
void TSimTGTIKProcessor::Process()
{
   fOutData->Clear("C");
   ...
   Float_t ene = gRandom->Gaus(fInitialBeamEnergy, beam_width);
   //Float_t ene = fInitialBeamEnergy;

   Float_t z        = get_reac_zpos(-300.0f, 900.0f, ene, winx, winy, det_energy, detx, dety, detz, id);
   Float_t ecm      = get_energy_cm(z, ene, winx, winy);
...
//==============================
// not modify
Float_t TSimTGTIKProcessor::get_reac_zpos(Float_t a, Float_t b, Float_t ini_energy, Float_t winx, Float_t winy, Float_t det_energy, Float_t detx, Float_t dety, Float_t detz, Int_t tel)
{
   Float_t z = bisect(a, b, ini_energy, winx, winy, det_energy, detx, dety, detz, tel);
   return z;
}

Float_t TSimTGTIKProcessor::get_energy_cm(Float_t z, Float_t ini_energy, Float_t winx, Float_t winy)
{
   if(!IsValid(z)) return kInvalidD;
   return beam_to_Ecm(z, ini_energy, winx, winy);
}

Float_t TSimTGTIKProcessor::get_theta_lab(Float_t z, Float_t detx, Float_t dety, Float_t detz)
{
   if(!IsValid(z)) return kInvalidD;
...
Float_t TSimTGTIKProcessor::get_theta_cm(Float_t z, Float_t det_energy, Float_t detx, Float_t dety, Float_t detz, Int_t tel, Float_t ecm, Float_t theta_lab)
{
   if(!IsValid(z)) return kInvalidD;
   Float_t ini_energy = det_energy;
   if(tel <= 3){
      Float_t tmp_energy = art::enewz::eoldz(fZ4, fM4, ini_energy, si, fPressure, fTemperature, firstlayer);
      ini_energy = tmp_energy;
   }

   Float_t distance = TMath::Sqrt(detx*detx + dety*dety + (detz-z)*(detz-z) );
   Float_t eRemain = MeV2J * art::enewz::eoldz(fZ4, fM4, ini_energy, he, fPressure, fTemperature, distance);
...
// for Newton method
//==============================
Float_t TSimTGTIKProcessor::beam_to_Ecm(Float_t z, Float_t ini_energy, Float_t winx, Float_t winy)
{
   ...
   if(z>0){
      ...
      distance = z; 
      eRemain = art::enewz::enewz(fZ1, fM1, ini_energy, he, fPressure, fTemperature, distance);
   }else{
      //distance = -z + win_expand; 
      distance = -z; 
      eRemain = art::enewz::eoldz(fZ1, fM1, ini_energy, he, fPressure, fTemperature, distance);
   }
   return J2MEV * particle1_to_Ecm(eRemain * MeV2J);
}


Float_t TSimTGTIKProcessor::det_to_Ecm(Float_t z, Float_t det_energy, Float_t detx, Float_t dety, Float_t detz, Int_t tel)
{
   Float_t ini_energy = det_energy;
   if(tel <= 3){
      Float_t tmp_energy = art::enewz::eoldz(fZ4, fM4, ini_energy, si, fPressure, fTemperature, firstlayer);
   ...
   Float_t distance = TMath::Sqrt(detx*detx + dety*dety + (detz-z)*(detz-z) );
   Float_t eRemain = art::enewz::eoldz(fZ4, fM4, ini_energy, he, fPressure, fTemperature, distance);
...
// not modify
Float_t TSimTGTIKProcessor::ObjFunc(Float_t z, Float_t ini_energy, Float_t winx, Float_t winy, Float_t det_energy, Float_t detx, Float_t dety, Float_t detz, Int_t tel)
{
...
// not modify
Float_t TSimTGTIKProcessor::bisect(Float_t a, Float_t b, Float_t ini_energy, Float_t winx, Float_t winy, Float_t det_energy, Float_t detx, Float_t dety, Float_t detz, Int_t tel)
{
   Double_t eps = 0.01;
   Int_t N = 1000;
   Int_t i = 0;
...
// Sub function
//==============================
Float_t TSimTGTIKProcessor::get_WinExpand(Float_t winx, Float_t winy, Float_t pressure)
{
...
// kinematics function
//==============================
Float_t TSimTGTIKProcessor::particle1_to_Ecm(Float_t e1)
{
   return e1 * M2/(M1+M2);
}

Float_t TSimTGTIKProcessor::particle4_to_Ecm(Float_t e4, Float_t theta)
{
...
Float_t TSimTGTIKProcessor::particle4_to_vcm(Float_t e4, Float_t theta)
{
