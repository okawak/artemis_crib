...
#ifndef _TSIMPARAMETER_H_ 
#define _TSIMPARAMETER_H_ 
...
class art::TSimParameter : public TParameterObject {
public:
   TSimParameter();
   virtual ~TSimParameter();

   TSimParameter(const TSimParameter& rhs);
   TSimParameter& operator=(const TSimParameter& rhs);
...
private:
   ...
   ClassDef(TSimParameter,1) // ppac parameter holder
};

#endif // _TSIMPARAMETER_H_
