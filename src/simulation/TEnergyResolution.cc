...
using art::TEnergyResolution;

ClassImp(TEnergyResolution)

TEnergyResolution::TEnergyResolution()
{
}
...
void TEnergyResolution::Init(TEventCollection *col)
{
   std::cout << "==================================================" << std::endl;
   ...
   for(Float_t ppaca = 0.0085f; ppaca<0.0100f; ppaca+=0.00001f){
      for(Float_t ppacb = 0.0100f; ppacb<0.0130f; ppacb+=0.00001f){
...
void TEnergyResolution::Process()
{
...
Double_t TEnergyResolution::ObjFunc(Float_t ppaca, Float_t ppacb, Bool_t debug)
{
...
Double_t TEnergyResolution::Getchi2(Float_t ppaca, Float_t ppacb, Float_t distance, Int_t i, Bool_t debug)
{
   Double_t lowgain[N];
...
Float_t TEnergyResolution::Brho2Energy(Float_t brho, Float_t m, Int_t z)
{
